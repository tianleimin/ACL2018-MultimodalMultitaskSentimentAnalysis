# FL multimodal multitask learning (valence+intensity) learning for ACL2018 emotion challenge
...
logger = open("/exports/csce/datastore/inf/groups/eddie_inf_hcrc_cstr_students/s1219694/ACL2018/prediction/output_FL_int.txt", "w")
sys.stdout = logger
...
auxiliary_output = Dense(4, activation='softmax', name='aux_output')(FL_layer_5) # Intensity classification
...
tst_pred_file = "/exports/csce/datastore/inf/groups/eddie_inf_hcrc_cstr_students/s1219694/ACL2018/prediction/pred_FL_int.txt"
