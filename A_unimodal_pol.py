# Vocal unimodal multitask learning (valence+polarity) for ACL2018 emotion challenge
...
logger = open("/exports/csce/datastore/inf/groups/eddie_inf_hcrc_cstr_students/s1219694/ACL2018/prediction/output_A_unimodal_pol.txt", "w")
sys.stdout = logger
...
auxiliary_output = Dense(1, activation='sigmoid', name='aux_output')(h5) # Polarity classification
...
tst_pred_file = "/exports/csce/datastore/inf/groups/eddie_inf_hcrc_cstr_students/s1219694/ACL2018/prediction/pred_A_unimodal_pol.txt"
